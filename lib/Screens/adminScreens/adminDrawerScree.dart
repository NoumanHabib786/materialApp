...
import 'package:material_app/Screens/adminScreens/addService.dart';
...
class Admin_Drawer_Screen extends StatefulWidget {
  const Admin_Drawer_Screen({Key? key}) : super(key: key);

  @override
  State<Admin_Drawer_Screen> createState() => _Admin_Drawer_ScreenState();
}

class _Admin_Drawer_ScreenState extends State<Admin_Drawer_Screen> {
  List drawer_list = [
                          ...
                          onTap: () {
                            setState(() {
                              if (index == 0) {
                                ...
                                navigate_push(
                                    context: context,
                                    next_Screen: ToolsCategory());
                              } else if (index == 2){
                                navigate_push(context: context, next_Screen: AddServiceScreen());

                              } else if (index == 3) {
                                Navigator.pop(context);
                                navigate_push(
                                    context: context,
                                    next_Screen: ProfileScreen());
                              }
                            });
                          },
                          minLeadingWidth: 10,
