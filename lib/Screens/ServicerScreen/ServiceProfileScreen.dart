...
class _ServiceProfileScreenState extends State<ServiceProfileScreen> {
  List<userModel> list = [
    ...
    userModel(name: "Service", uName: "123456789"),
    userModel(name: "Location", uName: "123456789"),
    userModel(name: "Experience", uName: "123456789"),
    userModel(name: "Age", uName: "123456789"),
  ];
                            ...
                            subtitle: Padding(
                              ...
                              child: Text(
                                index == 0
                                    ? "${data['name']}"
                                    : index == 1
                                        ? "${data['email']}":index == 2?"${data['number']}"
                                    :index == 3?"${data['type']}"
                                    :index == 4?"${data['location']}"
                                    :index == 5?"${data['experience']}"
                                        : "${data['age']}",
